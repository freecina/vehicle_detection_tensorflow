...
cap = cv2.VideoCapture('de_car.mp4')
frame_width = int(cap.get(3))
frame_height = int(cap.get(4))
out = cv2.VideoWriter('gan.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 10, (frame_width,frame_height))
sys.path.append("..")
    ...
    with detection_graph.as_default():
        with tf.Session(graph=detection_graph) as sess:
            ...
            while (cap.isOpened()):
                ...
                cv2.putText(image_np, "Detected Vehicles: " + str(temp_counter), (10, 35), font, 0.8, (0, 255, 255), 2,
                ...
                cv2.putText(image_np, "LAST PASSED VEHICLE INFO", (11, 290), font, 0.5, (255, 255, 255), 1,
                            cv2.FONT_HERSHEY_SIMPLEX)
                cv2.putText(image_np, "-Movement Direction: " + direction, (14, 302), font, 0.4, (255, 255, 255), 1,
                            cv2.FONT_HERSHEY_COMPLEX_SMALL)
                cv2.putText(image_np, "-Speed(km/h): " + speed, (14, 312), font, 0.4, (255, 255, 255), 1,
                            cv2.FONT_HERSHEY_COMPLEX_SMALL)
                cv2.putText(image_np, "-Color: " + color, (14, 322), font, 0.4, (255, 255, 255), 1,
                            cv2.FONT_HERSHEY_COMPLEX_SMALL)
                cv2.putText(image_np, "-Vehicle Size/Type: " + size, (14, 332), font, 0.4, (255, 255, 255), 1,
                            cv2.FONT_HERSHEY_COMPLEX_SMALL)
